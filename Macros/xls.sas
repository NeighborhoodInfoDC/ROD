...
define tagset Tagsets.ExcelBase;
    ...
    /*--------------------------------------------------------1Aug 05-*/
    log_note = "NOTE: This is the Excel XP tagset (Compatible with SAS 9.1.3 and above, v1.127, 09/26/2011). Add options(doc='help') to the ods statement for more information.";
        ...
        do /if font_size or cellheight;
           do /if $class_heights[htmlclass];
               set $converted_this_size $class_heights[htmlclass];
                ...
                set $convert_this_size font_size;
                trigger convert_to_points;
