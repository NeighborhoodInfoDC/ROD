/**************************************************************************
 ...
 Modifications:
12/31/09	ANW		Updated dates and reworked titles and dates so ran smoother;

**************************************************************************/
libname DCHFA "D:\DCData\Libraries\ROD\Prog\DCHFA";
%include "K:\Metro\PTatian\DCData\SAS\Inc\Stdhead.sas";
%include "K:\Metro\PTatian\DCData\SAS\Inc\AlphaSignon.sas" /nosource2;
options  mprint symbolgen;


%let first= '01jan2009'd; *first notice is after this date;
%let last= '01jan2009'd; *or last notice is after this date;
%let today= '31dec2009'd;
%let title= 12_31_2009; *title to identify foreclosures;
...
data foreclosures_date;
	...
	where adj_start_dt >= &first. or adj_end_dt >= &last.;
	run;
...
proc sort data=foreclosures_w_address2 out=dchfa.dchfa_&title. dupout= duplicate nodupkey;
by ssl;
run;

ods tagsets.excelxp file="D:\DCData\Libraries\ROD\Prog\DCHFA\DCHFA_&title..xls" style=minimal
      options(sheet_interval='page' );
	 

ods listing close;

ods tagsets.excelxp options( sheet_name="In for. at any point 2009");

proc print data=dchfa.dchfa_&title. label noobs;
	var
