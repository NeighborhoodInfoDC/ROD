	/**************************************************************************
	 ...
	 Modifications:
	  ...
	  12/14/10 RAG  Added verified thr. 11/18/10, unverified thr. 12/14/10.
	  12/20/10 RAG	Added verified thr. 11/30/10, unverified thr. 12/20/10.
	  01/03/11 RAG	Added verified thr. 12/08/10, unverified thr. 12/31/10.
	  01/07/11 LH   Added dup list macro.
	  01/18/11 RAG	Added verified thr. 12/21/10, unverified thr. 12/31/10
	  01/22/11 LH   Updated Multiple Lots.
	  01/24/11 RAG	Added verified thr. 12/30/10
	  01/31/11 RAG	Added verified thr. 12/31/10
	  02/07/11 RAG	Added verified thr. 12/31/10
	**************************************************************************/
	...
	** Define libraries **;
	...
	%Read_foreclosures(
	  finalize= Y,
	  revisions = %str(Added verified through 12/31/2010)  ,
	  year = 2010,
	  files = 
	   ...
	   Foreclosures_2010_p98
	   Foreclosures_2010_p99
	   Foreclosures_2010_p100
	   Foreclosures_2010_p101
	   Foreclosures_2010_p102
	   Foreclosures_2010_p103
	   Foreclosures_2010_p104
	   Foreclosures_2010_p105
	   Foreclosures_2010_p106
	   Foreclosures_2010_p107
	   Foreclosures_2010_p108
	   Foreclosures_2010_p109
	   Foreclosures_2010_p110
	   Foreclosures_2010_p111
	   Foreclosures_2010_p112
	   Foreclosures_2010_p113
