...
length record_type $23. prev_record_grantee prev_record_grantor $80. prev_record_accept prev_record_hstd $2.
	   prev_record_owner $150. prev_record_xlot $16. prev_record_owncat $3. prev_record_prp prev2_record_prp $38.; 
 ...
 set step2sorted;
   by ssl; 
	...
	retain firstnotice_date lastnotice_date  num_notice lastnotice_grantee lastnotice_grantor lastnotice_multiplelots lastnotice_xlot
		   prev_sale_hstd prev_sale_ownocc prev_sale_date prev_sale_price prev_sale_accept prev_sale_owner prev_sale_num prev_sale_owncat prev_sale_prp
		   prev_sale_aval prev_sale_ownocct prev_sale_units prev_record_days  num_sales post_sale_reo 
		   firstcancel_date lastcancel_date num_cancel outcome_date outcome_code  
		   tdeed_date tdeed_grantee tdeed_grantor num_tdeed
		   post_sale_date post_sale_price post_sale_accept post_sale_owner post_sale_hstd post_sale_ownocc post_sale_num post_sale_owncat post_sale_aval post_sale_prp;
...
*Resetting END for "Foreclosure Sale/REO" "Other Sale" if next record is a Trustees Deed within 31 days (1 month);
...
if first.ssl then do; 
	...
	prev_sale_hstd=" "; prev_sale_ownocct=.; prev_sale_units=.; prev_sale_prp=" "; outcome_code=.; lastnotice_multiplelots=.; lastnotice_xlot=" "; prev_sale_num=.; prev_sale_owncat=" ";
	tdeed_date=.; tdeed_grantee=" "; tdeed_grantor=" "; post_sale_date=.; post_sale_price=.; post_sale_accept=" "; post_sale_owner=" ";
	post_sale_hstd=" "; post_sale_ownocc=.; post_sale_num=.; post_sale_owncat=" "; post_sale_aval=.; post_sale_ownocct=.; post_sale_units=.; post_sale_reo=.; post_sale_prp=" ";
end;
...
if num_tdeed <=1 and prev_record_type in("Other Sale" "Foreclosure Sale/REO" "TD/Foreclosure Sale/REO" "TD/Other Sale" "Pre 1998 Sale") then do;
										  ...
										  prev_sale_prp=prev_record_prp;											end;
...
and post_sale_accept="05" and num_notice=0 then do; record_type="Other Sale"; outcome_code=.n; outcome_date=.n; ; end;

if end=1 then do; output; /*and firstnotice_date ~=.*/
	firstnotice_date=. ; lastnotice_date=.; outcome_date=.; prev_sale_date=.; prev_sale_price=.; 
	firstcancel_date=.; lastcancel_date=.; 	num_notice=0 ; num_cancel=0; num_tdeed=0;
	lastnotice_grantee=" "; lastnotice_grantor=" "; prev_sale_accept=" "; prev_sale_owner=" "; prev_sale_ownocc=.; prev_sale_aval=.;
	prev_sale_ownocct=.; prev_sale_units=.; prev_sale_prp=" ";
	...
	post_sale_units=.; post_sale_reo=.; post_sale_prp=" ";
end;
...
keep ssl filingdate_R filingdate ui_instrument num_notice  year firstnotice_date lastnotice_date lastnotice_grantee lastnotice_grantor
	tdeed_date tdeed_grantee tdeed_grantor num_tdeed
	prev_sale_date prev_sale_price prev_sale_accept prev_sale_owner prev_sale_hstd prev_sale_ownocc prev_sale_num prev_sale_owncat prev_sale_aval prev_sale_units prev_sale_ownocct prev_sale_prp
	
	post_sale_date post_sale_price post_sale_accept post_sale_owner post_sale_hstd post_sale_ownocc post_sale_num post_sale_owncat post_sale_aval post_sale_units post_sale_ownocct post_sale_prp
...
run;
data step7;
 set step6 (keep=saledate saleprice acceptcode hstd_code ownername owner_occ_sale sale_num ownercat ASSESS_VAL ssl order no_units no_ownocct ui_proptype);
...
format next_sale_owncat $owncat.;
...
data rod.&out (label="Foreclosure history, DC" drop=end lag_sale_num lag2_sale_num num_sales pv_owner ps_owner 
												ns_owner ln_grantor td_grantee);
	set step10;
...
%File_info( data=rod.&out, freqvars=outcome_code outcome_code2 post_sale_reo record_type post_sale_ownerR )
