...
/**************************************************************************
 Program:  Foreclosure_list_01_30_12.sas
 Library:  Rod
...
%let end_dt   = '30Jan2012'd;

%let previous_files =   Foreclosure_list_2011_12_27
...
ods tagsets.excelxp options( sheet_name="Notices and Certificates");

proc print data=Rod.Foreclosure_list_&file_date. label noobs;
  where ui_instrument in ('F1','D1','M1')and ui_proptype ne "12";;
...
ods tagsets.excelxp options( sheet_name="Coop Notices and Certificates");
proc print data=Rod.Foreclosure_list_&file_date. label noobs;
  where ui_instrument in ('F1','D1','M1') and ui_proptype= "12";
