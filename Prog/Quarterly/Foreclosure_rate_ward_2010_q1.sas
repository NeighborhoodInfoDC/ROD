...
%Foreclosures( out_ds=Foreclosure_detail, rpt_end_dt='31mar2010'd )
...
data Foreclosure_rate_ward_2010_q1;
...
proc print data=Foreclosure_rate_ward_2010_q1 (obs=50);
  id ward2002;
  by ward2002;
run;
...
ods rtf file="&path\Foreclosure_rate_ward_2010_q1.rtf" style=Styles.Rtf_arial_9pt;

proc tabulate data=Foreclosure_rate_ward_2010_q1 format=comma8.1 noseps missing;
  class ward2002 report_dt;
