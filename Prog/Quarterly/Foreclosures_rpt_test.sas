...
%macro Foreclosures( out_ds=, unit=, rpt_start_dt='01jan1999'd, rpt_end_dt= );
  ...
  data &out_ds;
    ...
    set Rod.Foreclosures_history_test;
...
%Foreclosures( out_ds=ROD.Foreclosures_qtr_2009_3_test, unit=qtr, rpt_end_dt='30sep2009'd )

%Foreclosures( out_ds=ROD.Foreclosures_year_2009_3_test, unit=year, rpt_end_dt='30sep2009'd )
