/**************************************************************************
 Program:  Prop_w_notice_tbl_2010_q4.sas
 Library:  HsngMon
...
proc summary data=&data nway;
  where ui_instrument = 'F1' and ui_proptype in ( '10', '11', '12', '13' ) and filingdate < '01jan2011'd;
...
proc summary data=&data nway;
  where ui_instrument = 'F1' and ui_proptype in ( '10', '11', '12', '13' ) and filingdate < '01jan2011'd and
